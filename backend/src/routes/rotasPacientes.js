...
const esquemaPaciente = {
  body: {
    ...
    properties: {
      ...
      contato_emergencia_nome: { type: ["string", "null"], maxLength: 120 },
      contato_emergencia_telefone: { type: ["string", "null"], maxLength: 20 },
      contato_emergencia_parentesco: { type: ["string", "null"], maxLength: 80 },
      endereco: { type: ["string", "null"], maxLength: 255 },
      acs: { type: ["string", "null"] },
      agente_id: {
